...
osascript -e 'tell app "Terminal"
    do script "cd Documents/Github/lab-project-1-sdn-zmid26; python3 switch.py 1 noname 12345"
end tell'
sleep 0.2

osascript -e 'tell app "Terminal"
    do script "cd Documents/Github/lab-project-1-sdn-zmid26; python3 switch.py 2 noname 12345"
end tell'
